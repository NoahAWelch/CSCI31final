...
import { insertMyGeoCard} from "../utils/supabase-client"
...
async function createCard(formData) {
    ...
    insertMyGeoCard({Answer1})
   // redirect('/services')
  }

export default function GeographyCard({Question, Answer1, Answer2, Answer3, Answer4}) {
